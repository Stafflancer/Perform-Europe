...
foreach ($csvHeader as $key => $header) {
    ...
    $display = 'custom_field' != (! empty($lastImport['selected_field'][$header]) ? $lastImport['selected_field'][$header] : null) ? 'style="display:none;"' : '';
    ...
    $sampleData = ! empty($csvSample[$key]) ? $csvSample[$key] : null;
