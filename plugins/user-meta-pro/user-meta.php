...
if (version_compare(PHP_VERSION, '5.6.0', '<')) {
    /**
     * 'User Meta Pro' will replaced by 'User Meta Lite' by deploy script for the lite version.
     */
    add_action('admin_notices', function () {
        echo '<div class=\"error\"><p>User Meta Pro plugin requires <strong>  PHP 5.6.0</strong> or above. Current PHP version: ' . PHP_VERSION . '</p></div>';
    });
    return;
}
