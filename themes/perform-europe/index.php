	        ...
	        if(!empty($categories)){ ?>
	            <div class="search__list__menu-wrp">
	                <div class="search__list__menu tabs">
	                    ...
	                    <div class="search__filter filter--current">
	                    ...
	                    foreach( $categories as $category ) { 
	                        ...
	                        <div class="search__filter">
	                            ...
	                            <div class="filter__highlight <?php if($category->name == 'News'){ echo 'bg-red'; } else if($category->name == 'Events'){ echo 'bg-yellow'; } else if($category->name == 'Resources'){ echo 'bg-green'; } else if($category->name == 'Resources'){ echo 'bg-white'; }  else if($category->name == 'Stories'){ echo 'bg-magenta'; }?>"></div>
	                        </div><?php
	                    } ?>
	                </div>
	            </div><?php
