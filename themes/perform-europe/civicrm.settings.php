...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://a23ac30a70b64aafb61d2a7d1e117376:6TxrHUUb9dReOJoCfmj6TKv4PRsQnFlA@dbhost:6033/pantheon?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['wp.frontend.base']['url'] = 'https://dev-perform-europe.pantheonsite.io/';
$civicrm_paths['wp.backend.base']['url'] = 'https://dev-perform-europe.pantheonsite.io/wp-admin/';
$civicrm_setting['domain']['userFrameworkResourceURL'] = 'https://dev-perform-europe.pantheonsite.io/wp-content/plugins/civicrm/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests') {
    ...
    define('CIVICRM_DSN', 'mysql://a23ac30a70b64aafb61d2a7d1e117376:6TxrHUUb9dReOJoCfmj6TKv4PRsQnFlA@dbhost:6033/pantheon?new_link=true');
  }
}
...
$civicrm_root = '/code/wp-content/plugins/civicrm/civicrm/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/code/wp-content/uploads/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://dev-perform-europe.pantheonsite.io');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'l3axr4AwfAIbfTnn6Z2zJA683TY5wluM1xShCsZilw');
}
...
if (!defined('CIVICRM_CRED_KEYS') ) {
  define( '_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:IFnklqOUBmcVzqtSTAU46DUqKEtYeZKUDzCaowtDPQmHz2iVA');
...
if (!defined('CIVICRM_DEPLOY_ID') ) {
  define( '_CIVICRM_DEPLOY_ID', 'vpiZcKfuL2IBXw');
...
if (!defined('CIVICRM_SIGN_KEYS') ) {
  define( '_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:pvxS53gCiKYDOyOUvpXCUGaj33ZXY6pXSSCI0SI6rtiQBJ0I4blUg');
...
// define( 'CIVICRM_MAIL_LOG', '/code/wp-content/uploads/civicrm/templates_c/mail.log');
// }
